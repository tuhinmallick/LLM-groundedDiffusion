...
for prompt_type in prompt_types:
    cache_path = f'cache/cache_{prompt_type.replace("lmd_", "")}{f"_{template_version}" if template_version != "v5" else ""}_{model}.json'
...
prompt_type = 'lmd'
cache_save_path = f'cache/cache_{prompt_type.replace("lmd_", "")}{f"_{template_version}" if template_version != "v5" else ""}_{model}.json'
